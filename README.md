...
![image-20230618232913408](C:\Users\86158\AppData\Roaming\Typora\typora-user-images\image-20230618232913408.png)

之后在Modbus Poll和Modbuus Slave中连接虚拟出来的串口，注意波特率等参数的配置，二者要相同

![image-20230618233425743](C:\Users\86158\AppData\Roaming\Typora\typora-user-images\image-20230618233425743.png)

连接成功之后，Modbus Poll会实时的读取Modbus Slave中的全部数据，也可以通过Modbus Poll修改Modbus Slave中的数据，可以通过Modbus Poll工具栏中的放大镜查看具体的报文

![image-20230618233832793](C:\Users\86158\AppData\Roaming\Typora\typora-user-images\image-20230618233832793.png)

# 2、STM32作为从机，串口调试助手作为主机

本系统中使用STM32作为从机，串口调试助手作为主机模拟modbus通讯功能效果如下：

![image-20230618223107995](C:\Users\86158\AppData\Roaming\Typora\typora-user-images\image-20230618223107995.png)
